  ...
  return (
    <section className="about-section">
      ...
      <article className="about-article">
        ...
        <p>
          Feeling inspired? You can unleash your inner Shakespeare (or your inner meme lord) by creating a new blog post on our <Link to="/createblog" className="about-link">Create Blog</Link> page. No judgment here.
        </p>
        <p>
